...
st.set_page_config(layout="wide",page_title="Resultados 1º Ano A - Fund. I", page_icon="🎛")

with open('style.css') as f:
    st.markdown(f'<style>{f.read()}</style>', unsafe_allow_html=True)

st.markdown("# Resultados 1º Ano A - Fund. I")
...
def carregar_dados():
    ...
    tabela = pd.read_excel('resultados_1_ano_a.xlsx')
    return tabela
