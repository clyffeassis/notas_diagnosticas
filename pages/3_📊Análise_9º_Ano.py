...
st.set_page_config(layout="wide",page_title="Resultados 9º Ano - Fund. II", page_icon="🎛")

with open('style.css') as f:
    st.markdown(f'<style>{f.read()}</style>', unsafe_allow_html=True)

st.markdown("# Resultados 9º Ano - Fund. II")
...
def carregar_dados():
    ...
    tabela = pd.read_excel('resultados.xls')
    return tabela

dados = carregar_dados()
# dados
conteudos1 = pd.read_excel('Prova_9_ano.xls')
# conteudos
